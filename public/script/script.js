...
/******/ 	var hotCurrentHash = "b15d630b7ef8c64f99df"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _htmlParseStringify = __webpack_require__(3);
	...
	function start() {
	  var cont = document.getElementById('virtual-dom');
	  ...
	  var newNode = h(
	    ...
	    h(
	      'ul',
	      { className: 'new-list__class', style: 'list-style: inherit' },
	      h(
	        'li',
	        null,
	        'item 1'
	  ...
	  function createElement(node) {
	    ...
	    node.children.map(createElement).forEach(function (childEl) {
	  ...
	  function changed(node1, node2) {
	    var test = (typeof node1 === 'undefined' ? 'undefined' : _typeof(node1)) !== (typeof node2 === 'undefined' ? 'undefined' : _typeof(node2)) || typeof node1 === 'string' && node1 !== node2 || node1.type !== node2.type;
	  ...
	  $('.btn-reload').click(function () {
	    return updateElement(cont, newNode, startNode);
	  });
	}
	...
	function parse() {
	  ...
	  function saveDom() {
	    ...
	    domsRepresentation.push(document.getElementById("test-parse-wraper"));
	
	    if (i < 1000) {
	      setTimeout(saveDom, 100);
	      i++;
	    }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/*jshint -W030 */
	var tagRE = /<(?:"[^"]*"['"]*|'[^']*'['"]*|[^'">])+>/g;
	var parseTag = __webpack_require__(5);
